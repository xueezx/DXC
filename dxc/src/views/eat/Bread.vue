  ...
  <div class="py">
    ...
    <div class="fu">
      <el-menu
        ...
        <el-menu-item @click="queryAllPastry()" index="1">面包</el-menu-item>
        <el-menu-item @click="queryAllPastry1()" index="2">蛋糕</el-menu-item>
      </el-menu>
    </div>
    <div class="contain">
      <div class="mbx">
      ...
      <div class="tupian">
        <div class="bg">
          <img src="../../assets/105744002a9c4270-4.jpg" alt="" />
        </div>
      </div>
      <div class="xzq">

  ...
  <div class="py">
    ...
    <div class="fu">
      <el-menu
        ...
        <el-menu-item @click="queryAllPastry()" index="1">散点</el-menu-item>
        <el-menu-item @click="queryAllPastry1()" index="2">糕点礼盒</el-menu-item>
      </el-menu>
    </div>
    <div class="contain">
      <div class="mbx">
        ...
        <div class="nei">
          <div class="gd2-2" v-for="(item,i) in pastrys" :key="item.id">
            <div class="pic" style="height: 380px;">
              <img style="height: 100%;" :src="p[i][0]" alt="" />
            </div>
            <div class="txt">
              <h1>

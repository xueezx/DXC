    ...
    <div>
        ...
        <div class="contain">
            ...
            <div class="contain-three">
                <div class="top">
                    <img src="@/assets/11315482885846657-2.png" alt="">
                </div>
                <div class="last">
                    <ul>
                        <li class="bng111">
                ...
                <div class="last">
                    <div class="right">
                        ...
                        <el-form :model="ruleForm" ref="ruleForm" label-width="100px" class="demo-ruleForm">
                            ...
                            <el-form-item label="您的留言" prop="desc">
...
div {
    ...
    .contain {
        ...
        >.contain-one {
            margin-top: -13px;
            width: 100%;
            background: url(@/assets/center-one.jpg) bottom no-repeat;
            height: 650px;
                    ...
                    >ul {
                        >li {
                            ...
                            >span {
                                ...
                                padding: 10px 20px 0;
                                height: 50px;
                                background: rgba(152, 102, 51, 0.6);
                                line-height: 20px;
                            }
                        }
                    }
        ...
        >.contain-four {
            ...
            >.last {
                width: 100%;
                height: 500px;
                background: url(@/assets/0925_1.jpg) center no-repeat;
